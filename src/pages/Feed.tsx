...
import { useSnippets, useSnippetInteraction, useFollowedSnippets, useGenerateSnippets } from '@/hooks/useSnippets';
...
export default function Feed() {
  ...
  const generateSnippets = useGenerateSnippets();
  ...
  const handleGenerateContent = useCallback(async () => {
    try {
      await generateSnippets.mutateAsync();
      toast({ 
        title: 'Content generated!', 
        description: 'Sample snippets have been created for you.',
        duration: 2000,
      });
    } catch (error) {
